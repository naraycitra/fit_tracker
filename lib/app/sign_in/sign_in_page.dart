...
import 'package:fit_tracker/app/sign_in/sign_in_view_model.dart';
import 'package:fit_tracker/app/sign_in/sign_in_button.dart';
...
class SignInPageContents extends StatelessWidget {
  const SignInPageContents(
      {Key? key, required this.viewModel, this.title = 'Workout Tracker'})
      : super(key: key);
